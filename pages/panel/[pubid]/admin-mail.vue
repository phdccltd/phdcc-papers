  ...
  <div>
    ...
    <div v-else>
      ...
      <b-form ref="form" @submit="onSubmit" @submit.stop.prevent>
        <b-form-group label="To" label-for="mailsubject" label-cols-sm="2">
        ...
        <b-form-group label="Subject" label-for="mailsubject" label-cols-sm="2">
          <b-form-input id="mailsubject" v-model="mailsubject" placeholder="Required" required v-on:input="clearmessages()"></b-form-input>
        </b-form-group>
        <b-form-group label="Text" label-for="mailtext" label-cols-sm="2">

<template>
  <div class="mt-1 mb-1">
    <NoticeMessage v-if="showHelp" variant="info">
      <b-button variant="link" class="float-end" @click="toggleHelp" data-cy="helpadminsetup-toggle">
      ...
      <p>
        Use this page to set up or alter your publication configuration
      </p>
    </NoticeMessage>

...
<div v-if="submit">
      <div v-if="showtype==1">
        ...
        <div class="publist-current-status clearfix">
          ...
          <span v-for="submitaction in submit.actions" :key="submitaction.id">
            <b-button v-if="showaction(submitaction)" class="float-end ms-1" variant="success" :to="submitaction.route">{{submitaction.name}}</b-button>
          </span>
          <div class="float-end">
      ...
      <div v-else class="border rounded border-black">
        ...
        <div class="publist-current-status clearfix">
          ...
          <span class="status">{{ submit.status }}</span>
          <span v-for="submitaction in submit.actions" :key="submitaction.id">
            <b-button v-if="showactiongrade(submitaction)" class="float-end ms-1" variant="success" @click="enterGrading(submit,submitaction)">{{submitaction.gradename}}</b-button>
            <b-button v-if="showaction(submitaction)" class="float-end ms-1" variant="success" :to="submitaction.route">{{submitaction.name}}</b-button>
          </span>
